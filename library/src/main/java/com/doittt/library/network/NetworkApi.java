package com.doittt.library.network;

import com.doittt.library.network.errorhandler.ExceptionHandle;
import com.doittt.library.network.errorhandler.HttpErrorHandler;
import com.doittt.library.network.interceptor.RequestInterceptor;
import com.doittt.library.network.interceptor.ResponseInterceptor;
    ...
    private static void getBaseUrl(ApiType apiType) {
        switch (apiType) {
            case SEARCH:
                ...
                break;
            case WEATHER:
                mBaseUrl = "https://devapi.qweather.com";//和风天气
            default:
                break;
        }
    }
